* Il ne faut pas seulement vérifier la date de modification, il faut aussi vérifier que chaque élément existe ou n'existe plus (nouveau fichier / fichier détruit)
